...
*/
    ...
    Log(GetName(GetArea(oTarget)), "Container tried to spawn base NWN loot. Name: " + GetName(oTarget) + " Tag: " + GetTag(oTarget) + " Item: " + sItemTemplate);
    // Put some gold in the chest.   
    CreateItemOnObject("nw_it_gold001", oTarget, d100());
