...
int StartingConditional()
{
    ...
    // do it in here, not in gs_inc_portal's ActivatePortal to ensure all pc's also receive xp for the portals they already found before
    // also not in gs_inc_portal's GetIsPortalActive, since then it would trigger for each portal the moment the list with active portals is constructed
