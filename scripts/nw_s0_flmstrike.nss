  ...
  while ( GetIsObjectValid(oTarget) )
  {
       if (spellsIsTarget(oTarget, SPELL_TARGET_STANDARDHOSTILE, OBJECT_SELF))
	   {
           ...
           if (!MyResistSpell(OBJECT_SELF, oTarget, 0.6))
    	   {
                ...
                nDamage2 = AR_GetReflexAdjustedDamage(nDamage/2, oTarget, AR_GetSpellSaveDC(), SAVING_THROW_TYPE_DIVINE);
                nDamage = AR_GetReflexAdjustedDamage(nDamage/2, oTarget, AR_GetSpellSaveDC(), SAVING_THROW_TYPE_FIRE);
