...
/*
    ...
    - Duration is 5 + 1/2 Class Level + base CHA
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    // Cooldown check.
    if(GetIsTimelocked(OBJECT_SELF, "Divine Wrath"))
    {
        TimelockErrorMessage(OBJECT_SELF, "Divine Wrath");
        return;
    }
    ...
    // New Duration is 3 + 1/2 CoT Levels + CHA mod
    int nDuration = 3 + (GetLevelByClass(CLASS_TYPE_DIVINECHAMPION) / 2) + GetAbilityModifier(ABILITY_CHARISMA);
    ...
    // 10 Minute Cooldown
        SetTimelock(OBJECT_SELF, FloatToInt(TurnsToSeconds(8)), "Divine Wrath", 120, 30);
}
