...
void main()
{
    ...
    string sDestination = "waypointtag";    // Put the tag of the destination Waypoint here
    string sNameToShout = "my destination"; // This is the name the player will shout out announcing departure
    ///////////////////////////////////////////////////
