...
/*
 ...
 - Duration made into hours / level
...
// End of Spell Cast Hook
    ...
    int nDuration = AR_GetCasterLevel(OBJECT_SELF); // * Duration 1 hour/level
    if (nMetaMagic == METAMAGIC_EXTEND)	//Duration is +100%
    {
         nDuration = nDuration * 2;
    }

	   // Duration is either hours/lvl or turns/lvl, depending on if the caster is a paladin
	   float fDuration;
