...
void _ProcessChat(string sText)
  {
	...
	else if (Contains(sText, "gods") && Address(oSpeaker) == gsCMGetFirstName(oSpeaker))
	{
	  Say("You want to know about the gods?  Of what would you hear, ascension or power?");
	}
	else if (Contains(sText, "ascension") && Address(oSpeaker) == gsCMGetFirstName(oSpeaker))
	{
	...
	else if (Contains(sText, "power") && Address(oSpeaker) == gsCMGetFirstName(oSpeaker))
	{
	...
	else if ((Contains(sText, "more") || Contains(sText, "touch")) && Address(oSpeaker) == gsCMGetFirstName(oSpeaker))
	{
