...
void main()
{
   ...
   if (!GetHasFeat(FEAT_BARD_SONGS, OBJECT_SELF))
   {
    ...
    //::  Not useable in Anti-magic areas, e.g Cage Fights
    if ( gsFLGetAreaFlag("OVERRIDE_MAGIC", OBJECT_SELF) )
    {
        FloatingTextStringOnCreature("The Anti-Magic zone prevents your song from having any effect.", OBJECT_SELF, FALSE);
        return;
    }
