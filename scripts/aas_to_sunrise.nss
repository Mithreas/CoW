...
void main()
{
    ...
    string sDestination = "wp_sunrise";    // Put the tag of the destination Waypoint here
    string sNameToShout = "Sunrise Isle"; // This is the name the player will shout out announcing departure
    ///////////////////////////////////////////////////
