...

{
  ...
  string sMenu3Blunts = CnrRecipeAddSubMenu("cnranvirwpnlir", "Silver Blunts");
  ...
  sKeyToRecipe = CnrRecipeCreateRecipe(sMenu3Subs, "Small Silver Blade", "cnrshod3", 1);
  CnrRecipeAddComponent(sKeyToRecipe, "cnringotsil", 1);
  CnrRecipeSetRecipeLevel(sKeyToRecipe, 5);
  CnrRecipeSetRecipeXP(sKeyToRecipe, 50, 50);
  CnrRecipeSetRecipeAbilityPercentages(sKeyToRecipe, 70, 30, 0, 0, 0, 0);
  ...
  sKeyToRecipe = CnrRecipeCreateRecipe(sMenu3Ammo, "Silver Throwing Knives", "cnrthrow3", 1);
  CnrRecipeAddComponent(sKeyToRecipe, "cnringotsil", 1);
  CnrRecipeSetRecipeLevel(sKeyToRecipe, 5);
  CnrRecipeSetRecipeXP(sKeyToRecipe, 50, 50);
  CnrRecipeSetRecipeAbilityPercentages(sKeyToRecipe, 70, 30, 0, 0, 0, 0);
