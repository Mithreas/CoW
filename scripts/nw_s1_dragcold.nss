...
void main()
{
    ...
    if(GetLocalInt(OBJECT_SELF, "Override_ColdBreath_DamageDice"))
    {
        nDamage = d6(GetLocalInt(OBJECT_SELF, "Override_ColdBreath_DamageDice"));
    }
    if(GetLocalInt(OBJECT_SELF, "Override_ColdBreath_DC"))
    {
        nDC = GetLocalInt(OBJECT_SELF, "Override_ColdBreath_DC");
    }
