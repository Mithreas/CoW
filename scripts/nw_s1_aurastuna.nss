...
void main()
{
    ...
    //::  Air Monolith Shape, fixed 14 DC, 1 Round Duration
    int bPolymorphedPC = GetHasEffect(EFFECT_TYPE_POLYMORPH, GetAreaOfEffectCreator()) && GetIsPC(GetAreaOfEffectCreator());
    if ( bPolymorphedPC ) {
        nDC = 14;
        nDuration = 1;
    }
