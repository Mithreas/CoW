...
int GetPCRank (string sFaction, int nRepScore)
{
  ...
  {
    string sCurrentRankScoreAsString = SQLDecodeSpecialChars(SQLGetData(1));
...
string GetRankName(string sFaction, int nRank)
{
  ...
  if (SQLFetch() == SQL_SUCCESS)
  {
    string sRankName = SQLDecodeSpecialChars(SQLGetData(1));
...
int GetRepNeededForRank(string sFaction, int nRank)
{
  ...
  if (SQLFetch() == SQL_SUCCESS)
  {
    string sScoreAsString = SQLDecodeSpecialChars(SQLGetData(1));
