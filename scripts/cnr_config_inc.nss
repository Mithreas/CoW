...
float CNR_FLOAT_ORE_MINING_DEPOSIT_RESPAWN_TIME_SECS = 3600.0; // 60 mins real time
...
float CNR_FLOAT_GEM_MINING_DEPOSIT_RESPAWN_TIME_SECS = 3600.0; // 60 mins real time
...
float CNR_FLOAT_MISC_MINING_DEPOSIT_RESPAWN_TIME_SECS = 3600.0; // 60 mins real time

// wood cutting
float CNR_FLOAT_WOOD_MINING_AXE_BREAKAGE_PERCENTAGE = 0.2;
float CNR_FLOAT_WOOD_MINING_TREE_BREAKAGE_PERCENTAGE = 1.0;
float CNR_FLOAT_WOOD_MINING_TREE_RESPAWN_TIME_SECS = 3600.0; // 60 mins real time
...
float CNR_FLOAT_DEFAULT_PLANT_RESPAWN_TIME_SECS = 900.0; // 15 mins real time
