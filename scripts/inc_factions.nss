...
create table fb_fa_messages (faction VARCHAR(51), message TEXT, timestamp INT(11), modified TIMESTAMP(8));
  ...
  Update by Mith, March 2008:
    ...
    object.  See miDAGetCacheObject() in inc_database.
...
//Faction types
const int FAC_NATION = 0x40000000; //used in inc_citizen w/o the constant due to circular depenancies.. be mindful if needs to be changed
...
//Due to errors in implementing inc_factions2 as an include with
