//::///////////////////////////////////////////////
//:: Spell: Lesser Prismatic Breath
//:: spl_lsrprismbrth
//:://////////////////////////////////////////////
/*
    Modified version of prismatic dragon's
    breath weapon with lesser effects.
*/
//:://////////////////////////////////////////////
...
int PDGetBreathDC()
{
    return 10 + GetHitDice(OBJECT_SELF) / 2;
}
        ...
        case 5: //Paralyze
            {
                ...
                if (MySavingThrow(SAVING_THROW_FORT, oTarget, PDGetBreathDC()) == 0)
                {
                    ...
                    DelayCommand(fDelay, ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eLink, oTarget, RoundsToSeconds(d3())));
                }
            }
        break;
        case 6: //Confusion
