...

{
  ...
  sKeyToRecipe = CnrRecipeCreateRecipe(sMenu1Subs, "Small Ondaran Blade", "cnrshod1", 1);
  CnrRecipeAddComponent(sKeyToRecipe, "cnringotond", 1);
  CnrRecipeSetRecipeLevel(sKeyToRecipe, 1);
  CnrRecipeSetRecipeXP(sKeyToRecipe, 10, 10);
  CnrRecipeSetRecipeAbilityPercentages(sKeyToRecipe, 70, 30, 0, 0, 0, 0);
  ...
  sKeyToRecipe = CnrRecipeCreateRecipe(sMenu1Ammo, "Ondaran Bullets", "cnrbullet1", 1);
  CnrRecipeAddComponent(sKeyToRecipe, "cnringotond", 1);
  CnrRecipeSetRecipeLevel(sKeyToRecipe, 1);
  CnrRecipeSetRecipeXP(sKeyToRecipe, 10, 10);
  CnrRecipeSetRecipeAbilityPercentages(sKeyToRecipe, 70, 30, 0, 0, 0, 0);

  sKeyToRecipe = CnrRecipeCreateRecipe(sMenu1Ammo, "Ondaran Throwing Knives", "cnrthrow1", 1);
  CnrRecipeAddComponent(sKeyToRecipe, "cnringotond", 1);
  CnrRecipeSetRecipeLevel(sKeyToRecipe, 1);
  CnrRecipeSetRecipeXP(sKeyToRecipe, 10, 10);
  CnrRecipeSetRecipeAbilityPercentages(sKeyToRecipe, 70, 30, 0, 0, 0, 0);
  ...
  sKeyToRecipe = CnrRecipeCreateRecipe(sMenu1Blunts, "Ondaran Shod Quarterstaff", "cnrqstaff1", 1);
  CnrRecipeAddComponent(sKeyToRecipe, "cnrqstaffs", 1);
