...
const string HELP_2 = "If you have more than one valid associate for use with this command, then you must first specify one by selecting it with the Control Associate feat.\n\nExample:\n<c‡Îë>-associate I am John Doe's associate.\n-associate /s This is a shout.</c>";
...
void main()
{
  ...
  else
  {
    ...
    {
        SendMessageToPC(oSpeaker, "You currently have multiple associates that can speak for you. Please select one with Control Associate before using this command.");
        return;
    }
