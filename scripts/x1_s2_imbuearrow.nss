...
void main()
{
    ...
    int nCasterLvl = GetLevelByClass(CLASS_TYPE_ARCANE_ARCHER,oCaster) + GetLocalInt(gsPCGetCreatureHide(OBJECT_SELF), "FL_LEVEL") /5; 
    int nDamage;
    float fDelay;
    ...
    if (nCasterLvl > 10 + GetLevelByClass(CLASS_TYPE_ARCANE_ARCHER,oCaster))
    {
        nCasterLvl = 10 + GetLevelByClass(CLASS_TYPE_ARCANE_ARCHER,oCaster);
    }
