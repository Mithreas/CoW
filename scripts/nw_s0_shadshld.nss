...
// End of Spell Cast Hook
    ...
    int feylock = miWAGetIsWarlock(OBJECT_SELF) == PACT_FEY;
    effect eVis = feylock ? EffectVisualEffect(VFX_IMP_CHARM) : EffectVisualEffect(VFX_IMP_DEATH_WARD);
    effect eShadow = feylock ? EffectVisualEffect(VFX_DUR_ETHEREAL_VISAGE) : EffectVisualEffect(VFX_DUR_PROT_SHADOW_ARMOR);
