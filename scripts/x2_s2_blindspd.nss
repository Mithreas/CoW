...
// End of Spell Cast Hook
    ...
    IncrementRemainingFeatUses(OBJECT_SELF, FEAT_EPIC_BLINDING_SPEED);
	gsSTDoCasterDamage(OBJECT_SELF, 25);
	
    // Apply effects to the currently selected target.
    ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eLink, oTarget, TurnsToSeconds(3));
