...

{
  ...
  string sMenu2Blunts = CnrRecipeAddSubMenu("cnranvirwpnelf", "Iron Blunts");
  ...
  sKeyToRecipe = CnrRecipeCreateRecipe(sMenu2Subs, "Small Iron Blade", "cnrshod2", 1);
  CnrRecipeAddComponent(sKeyToRecipe, "cnringotiro", 1);
  CnrRecipeSetRecipeLevel(sKeyToRecipe, 3);
  CnrRecipeSetRecipeXP(sKeyToRecipe, 30, 30);
  CnrRecipeSetRecipeAbilityPercentages(sKeyToRecipe, 70, 30, 0, 0, 0, 0);
  ...
  sKeyToRecipe = CnrRecipeCreateRecipe(sMenu2Ammo, "Iron Throwing Knives", "cnrthrow2", 1);
  CnrRecipeAddComponent(sKeyToRecipe, "cnringotiro", 1);
  CnrRecipeSetRecipeLevel(sKeyToRecipe, 3);
  CnrRecipeSetRecipeXP(sKeyToRecipe, 30, 30);
  CnrRecipeSetRecipeAbilityPercentages(sKeyToRecipe, 70, 30, 0, 0, 0, 0);
