// Werebeetle shapechanger userdefined AI script.
// If one wereshark is brought below 50% health, the whole pack (school?) should shift. 
#include "inc_event"

void gsPolymorph()
{
    // Shark appearances are 17,18,19 and 20.  Pick one at random.
	SetCreatureAppearanceType(OBJECT_SELF, 16 + d4());
...
//................................................................
        if (! GetLocalInt(OBJECT_SELF, "GS_POLYMORPH") && GetCurrentHitPoints() < GetMaxHitPoints()/2)
        {
            DelayCommand(1.0, gsPolymorph());
            SetLocalInt(OBJECT_SELF, "GS_POLYMORPH", TRUE);
			SpeakString("WEREBEETLE_SHIFT", TALKVOLUME_SILENT_TALK);
        }
...
//................................................................
    ...
    case GS_EV_ON_SPAWN:
//................................................................
        SetListenPattern(OBJECT_SELF, "WEREBEETLE_SHIFT", 10005);
