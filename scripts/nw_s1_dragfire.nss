...
void main()
{
    ...
    if(GetLocalInt(OBJECT_SELF, "Override_FireBreath_DamageDice"))
    {
        nDamage = d10(GetLocalInt(OBJECT_SELF, "Override_FireBreath_DamageDice"));
    }
    if(GetLocalInt(OBJECT_SELF, "Override_FireBreath_DC"))
    {
        nDC = GetLocalInt(OBJECT_SELF, "Override_FireBreath_DC");
    }
